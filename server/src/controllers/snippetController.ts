...
export class SnippetController {
  ...
  public async validateSnippet(req: express.Request, res: express.Response, next: express.NextFunction) {
    let snippet;
    try {
  ...
  public async post(req: express.Request, res: express.Response) {
    ...
    const createdSnippet = await this.snippetRepository.create(snippet).catch(err => res.send(err));
